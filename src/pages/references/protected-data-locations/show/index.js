      ...
      <Card>
        ...
        {currentUser.roles.includes('moderator') && <CardActions>
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <FlatButton
              label="Edit"
              containerElement={<Link to={`/references/protected-data-locations/edit/${data.id}`} />}
            />
            <FlatButton
              label="Remove"
...
ProtectedDataLocation.propTypes = {
...
export default smartify(ProtectedDataLocation);
